...
public class AttendeeAction extends play.mvc.Action.Simple {
    private final Logger logger = LoggerFactory.getLogger("application.AttendeeAction");
    ...
    @Singleton
    @Inject
    public AttendeeAction(MetricRegistry metrics, HttpExecutionContext ec, Futures futures) {
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(AttendeeAction.class, "responsesTimer"));
    }
