...
import v1.attendee.AttendeeRepository;
import v1.attendee.JPAAttendeeRepository;
...
public class Module extends AbstractModule {
    ...
    public void configure() {
        ...
        bind(AttendeeRepository.class).to(JPAAttendeeRepository.class).asEagerSingleton();
    }
}
